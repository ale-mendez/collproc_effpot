...
%DIF DEL dimmolv1.tex   Sun Apr 14 02:39:41 2019
%DIF ADD dimmol.tex     Sun Apr 14 02:44:59 2019
...
such as the {\sc parsec}\DIFaddbegin \DIFadd{, }\DIFaddend for example~\cite{parsecwebpage,Chelikowsky1994}, 
...
one--electron equation. Next, \DIFaddbegin \DIFadd{a }\DIFaddend careful optimisation of the potential is 
...
(1) The \DIFdelbegin \DIFdel{calculation is restrained }\DIFdelend \DIFaddbegin \DIFadd{calculations are constrained }\DIFaddend to Hamiltonians describing only
the moving projectile, the target and the active 
electron. (2) The transition matrix elements are only considered in  
first perturbative order. If the first order \DIFdelbegin \DIFdel{description fails, indeed }\DIFdelend \DIFaddbegin \DIFadd{fails, }\DIFaddend it would not have 
...
approximation (FBA)~\cite{BatesBook,McDowell1961}, to \DIFdelbegin \DIFdel{the much 
more sophisticated
time--dependent close--coupling 
methods~\mbox{%DIFAUXCMD
\cite{LeePindzola2011,Pindzola2016}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{more sophisticated
fully quantum mechanical methods~\mbox{%DIFAUXCMD
\cite{Pindzola2007,Burke2011,Bray2017,Pindzola2016}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . 
...
In general, the pseudopotentials \DIFdelbegin \DIFdel{$V_{\mbox{\tiny PPA}}$ }\DIFdelend \DIFaddbegin \DIFadd{$V_{\mbox{\tiny PP}}$ }\DIFaddend can be defined 
through a pseudo--charge \DIFdelbegin \DIFdel{$Z_{\mbox{\tiny PPA}}$ as
}\DIFdelend \DIFaddbegin \DIFadd{$Z_{\mbox{\tiny PP}}$ as
}\DIFaddend \begin{equation}
 V\DIFdelbegin \DIFdel{_{\mbox{\tiny PPA}}}\DIFdelend \DIFaddbegin \DIFadd{_{\mbox{\tiny PP}}}\DIFaddend (r)=-\DIFdelbegin \DIFdel{\frac{Z_{\mbox{\tiny PPA}}(r)}{r} }\DIFdelend \DIFaddbegin \DIFadd{\frac{Z_{\mbox{\tiny PP}}(r)}{r} }\DIFaddend \,,
 \label{eq:pseudopotential}
\end{equation}
\begin{equation}
 Z\DIFdelbegin \DIFdel{_{\mbox{\tiny PPA}}}\DIFdelend \DIFaddbegin \DIFadd{_{\mbox{\tiny PP}}}\DIFaddend (r)=\bigg\{
 \begin{array}{cl}
  f(r), & r\leq r_c \\
  1, & r>r_c 
 \end{array} 
...
argon. Notice that the pseudopotential behaves as \DIFdelbegin \DIFdel{$-1/r$ }\DIFdelend \DIFaddbegin \DIFadd{$-r^{-1}$ }\DIFaddend (dot--dash 
...
we considered CH$_4$, which is a highly symmetric\DIFdelbegin \DIFdel{molecule. Furthermore, the spherical symmetry of the methane molecule
allows the system to be successfully described , for high energies, 
with a }\DIFdelend \DIFaddbegin \DIFadd{, and therefore, can
be described with an }\DIFaddend angular averaged potential\DIFaddbegin \DIFadd{~}\DIFaddend \cite{Granados2016}.
We computed the HF molecular orbitals and energies of CH$_4$ employing 
the UGBS basis sets of carbon and hydrogen\DIFdelbegin \DIFdel{. Previous works 
\mbox{%DIFAUXCMD
\cite{Rothenberg1971,Hariharan1972} }\hspace{0pt}%DIFAUXCMD
have shown that accurate molecular 
orbitals for methane require the inclusion of further polarisation functions
to represent the distortion of the atoms}\DIFdelend \DIFaddbegin \DIFadd{, which considers angular momenta
up to $L=1$.
...
\mbox{%DIFAUXCMD
\cite{Rothenberg1971,Hariharan1972}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . However, to \DIFdelbegin \DIFdel{solely 
}\DIFdelend isolate the effects of the
...
The orientation of the molecular targets is \DIFdelbegin \DIFdel{crucial }\DIFdelend \DIFaddbegin \DIFadd{important }\DIFaddend for determining
the cross sections of collisional processes. However, \DIFdelbegin \DIFdel{the molecular 
orientations in most collisional experiments are }\DIFdelend \DIFaddbegin \DIFadd{it is }\DIFaddend generally not 
pre--established \DIFaddbegin \DIFadd{in the experiments}\DIFaddend . Thus, the spherically averaged 
...
\DIFdelbegin %DIFDELCMD < \bibitem{LeePindzola2011}
%DIFDELCMD < %%%
\DIFdel{Lee}\DIFdelend \DIFaddbegin \bibitem{Pindzola2007}
\DIFadd{Pindzola, M. S.; Robicheaux, F.; Loch, S. D.; Berengut,  J. C.; Topcu}\DIFaddend , T.\DIFdelbegin \DIFdel{-G.; Pindzola}\DIFdelend \DIFaddbegin \DIFadd{; Colgan, J.; Foster}\DIFaddend , M.\DIFdelbegin \DIFdel{S. Proton-impact excitation of lithium using a time--dependent 
close--coupling method }\DIFdelend \DIFaddbegin \DIFadd{; Griffin, D. C.; Ballance, C. P.; Schultz, D. R.;
...
processes}\DIFaddend .
{\it \DIFdelbegin \DIFdel{Phys}\DIFdelend \DIFaddbegin \DIFadd{J. Phys. B}}\DIFadd{, }{\bf \DIFadd{2007}}\DIFadd{, 40, R39-R60}\DIFaddend .
\DIFdelbegin \DIFdel{Rev.A}\DIFdelend \DIFaddbegin 

\bibitem{Burke2011}
\DIFadd{Burke, P. G.
}{\it \DIFadd{R--Matrix Theory of Atomic Collisions.}}
\DIFadd{Springer--Verlag Berlin Heidelberg, 2011.
}

\bibitem{Bray2017}
\DIFadd{Bray, I; Abdurakhmanov, I. B.; Bailey, J. J.; Bray, A. W.; Fursa, D. V.;
...
}{\it \DIFadd{J. Phy. B}\DIFaddend }\DIFaddbegin \DIFadd{, }\DIFaddend {\bf \DIFdelbegin \DIFdel{2011}\DIFdelend \DIFaddbegin \DIFadd{2017}\DIFaddend }, \DIFdelbegin \DIFdel{84, 052712.
}\DIFdelend \DIFaddbegin \DIFadd{50, 202001. 
}\DIFaddend 
